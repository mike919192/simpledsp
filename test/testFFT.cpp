...
template <size_t N>
double calc_max_error(const sdsp::complex_array_t<N> &observed, const sdsp::complex_array_t<N> &expected)
{
...
TEST_CASE("FFT Radix 2 linearity", "[single-file]")
{
    ...
    sdsp::complex_array_t<N> x1{ 0 };
    sdsp::complex_array_t<N> x2{ 0 };
...
{
    sdsp::complex_array_t<1024> complexValues{ 0.3535, 0.3535, 0.6464, 1.0607, 0.3535, -1.0607, -1.3535, -0.3535 };

    BENCHMARK("Radix2 FFT")
    {
        sdsp::complex_array_t<1024> complexValues2 = complexValues;
